...
const Division12 = () => {
    ...
    return (
        <div>
            ...
            <div
                style={{
                    backgroundImage: `url(${publicUrl}/assets/img/blog/division/d12/Desktop - 49.svg)`,
            ...
            >
                <img
                    src={`${publicUrl}/assets/img/blog/division/d12/Desktop - 49.svg`}
                    alt="D12 Chart"
                ...
                <div style={{ backgroundColor: 'white', width: '86vw' }} className='mt-8 p-10 rounded-2xl'>
                    ...
                    <div className='w-full flex md:flex-row flex-col items-center mt-20 pb-8 gap-8'>
                        <div className="md:w-1/2 w-full flex flex-col items-center px-6 gap-3">
                            <img src={`${publicUrl}/assets/img/blog/division/d12/Desktop - 49.svg`} alt="D12 Chart" className="rounded-lg object-contain scale-[1.2] w-full" />
                        </div>
                        <div className='md:w-1/2 w-full flex flex-col justify-center px-6 gap-3'>
                            <p className='text-3xl font-bold' style={{ color: "#5D0000" }}>Dwadashamsa Chart (D12)</p>
                            <p className='text-black font-medium'>Content for D12 division goes here.</p>
                        </div>
                    </div>
                    {/* Second Row: Text & Chart */}
                    <div className='w-full flex md:flex-row flex-col items-center mt-20 pb-8 gap-8'>
                        <div className='md:w-1/2 w-full flex flex-col justify-center px-6 gap-3'>
                            <p className='text-2xl font-bold mt-6' style={{ color: "#5D0000" }}>Key Points to Analyze in D12:</p>
