            ...
            >
                ...
                <div style={{ backgroundColor: "white", width: "100%", maxWidth: "86vw" }} className='mt-8 px-2 md:px-10 py-4 md:py-10 rounded-lg'>
                    ...
                    <div className='flex flex-col md:flex-row items-start mb-6'>
                        ...
                        <img src={publicUrl + '/assets/img/blog/division/D6body.jpg'} alt="D6 Body" className='w-full md:w-1/2 max-w-xs sm:max-w-md md:max-w-lg rounded-lg shadow-lg' style={{objectFit: 'contain'}} />
                    </div>
                    ...
                    <div className='flex flex-col md:flex-row items-start border border-blue-400 rounded-lg p-2 md:p-4'>
                        <div className='md:w-1/2 w-full flex flex-col items-center md:items-start mb-4 md:mb-0 md:mr-6'>
                            <img src={publicUrl + '/assets/img/blog/division/D6DNA.jpg'} alt="D6 DNA" className='w-full max-w-xs sm:max-w-md md:max-w-md rounded-lg shadow-lg mb-2' style={{objectFit: 'contain'}} />
                        ...
                        <div className='md:w-1/2 w-full'>
                            <h2 className='text-lg md:text-2xl font-bold mb-2' style={{ color: '#7B1F1F', borderBottom: '1px dashed #7B1F1F' }}>Practical Benefits of Analyzing the D6 Chart</h2>
                            <p className='text-black font-medium text-sm md:text-base' style={{textAlign: 'justify'}}>
