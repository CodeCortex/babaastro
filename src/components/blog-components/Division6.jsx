    ...
    return (
        <div>
            ...
            >
                ...
                <div style={{ backgroundColor: "white", width: "86vw" }} className='mt-8 p-4 md:p-8'>
                    {/* 1. Table left, intro text right */}
                    <div className='flex flex-col md:flex-row items-start mb-6'>
                        <img src={publicUrl + '/assets/img/blog/division/D6Table.jpg'} alt="D6 Table" className='w-full md:w-1/2 max-w-lg rounded-lg shadow-lg mb-4 md:mb-0 md:mr-6' style={{objectFit: 'contain'}} />
                        <div className='md:w-1/2'>
                            <h2 className='text-xl md:text-2xl font-bold mb-2' style={{ color: '#7B1F1F' }}>What is the D6 – Shashtamsa Chart and Why Does It Matter?</h2>
                            <p className='text-black font-medium' style={{textAlign: 'justify'}}>
                    ...
                    <div className='flex flex-col md:flex-row items-start mb-6'>
                        <div className='md:w-1/2 mb-4 md:mb-0 md:mr-6'>
                            <h2 className='text-xl md:text-2xl font-bold mb-2' style={{ color: '#7B1F1F' }}>How is D6 Calculated and What to Look For?</h2>
                            <p className='text-black font-medium' style={{textAlign: 'justify'}}>
                        ...
                        <img src={publicUrl + '/assets/img/blog/division/D6body.jpg'} alt="D6 Body" className='w-full md:w-1/2 max-w-lg rounded-lg shadow-lg' style={{objectFit: 'contain'}} />
                    </div>
                    ...
                    <div className='flex flex-col md:flex-row items-start border border-blue-400 rounded-lg p-2 md:p-4'>
                        <div className='md:w-1/2 flex flex-col items-center md:items-start mb-4 md:mb-0 md:mr-6'>
                            <img src={publicUrl + '/assets/img/blog/division/D6DNA.jpg'} alt="D6 DNA" className='w-full max-w-md rounded-lg shadow-lg mb-2' style={{objectFit: 'contain'}} />
                            <img src={publicUrl + '/assets/img/blog/division/D6BodyPart.jpg'} alt="D6 Body Parts" className='w-full max-w-md rounded-lg shadow-lg' style={{objectFit: 'contain'}} />
                        </div>
                        <div className='md:w-1/2'>
                            <h2 className='text-xl md:text-2xl font-bold mb-2' style={{ color: '#7B1F1F', borderBottom: '1px dashed #7B1F1F' }}>Practical Benefits of Analyzing the D6 Chart</h2>
                            <p className='text-black font-medium' style={{textAlign: 'justify'}}>
