...
const Division6 = () => {
    ...
    return (
        <div>
            ...
            >
                <h1 style={{ fontSize: '12vw', minFontSize: '48px', textShadow: '2px 2px 3px black', paddingTop: "20vw", paddingBottom: "20vw" }} className="text-white font-extrabold sm:text-7xl md:text-9xl">
                    D6
                </h1>
            </div>
            ...
            >
                <div style={{ position: 'relative', width: '100%', maxWidth: '90vw', margin: '0 auto' }} className='flex flex-col items-center'>
                    <div style={{ backgroundColor: '#e6e6e6' }} className='h-20 md:h-24 lg:h-32 w-full flex items-center justify-center rounded-2xl text-base md:text-lg lg:text-2xl font-semibold text-gray-700'>
                        Space for website ad
                    </div>
                    <img 
                        src={publicUrl + '/assets/img/blog/division/astrologer.png'}
                        alt="Astrologer" 
                        style={{ position: 'absolute', right: '0%', bottom: '-15px', height: '30vw', maxHeight: '300px', width: 'auto', minHeight: '120px' }} 
                ...
                <div style={{ backgroundColor: "white", width: "100%", maxWidth: "86vw" }} className='mt-8 px-2 md:px-10 py-4 md:py-10 rounded-lg'>
                    ...
                    <div className='flex flex-col md:flex-row items-start mb-6'>
                        <img src={publicUrl + '/assets/img/blog/division/D6Table.jpg'} alt="D6 Table" className='w-full md:w-1/2 max-w-xs sm:max-w-md md:max-w-lg rounded-lg shadow-lg mb-4 md:mb-0 md:mr-6' style={{objectFit: 'contain'}} />
                    ...
                    <div className='flex flex-col md:flex-row items-start mb-6'>
                        ...
                        <img src={publicUrl + '/assets/img/blog/division/D6body.jpg'} alt="D6 Body" className='w-full md:w-1/2 max-w-xs sm:max-w-md md:max-w-lg rounded-lg shadow-lg mb-4 md:mb-0' style={{objectFit: 'contain'}} />
                    </div>
                    ...
                    <div className='flex flex-col md:flex-row items-start border border-blue-400 rounded-lg p-2 md:p-4'>
                        <div className='md:w-1/2 w-full flex flex-col items-center md:items-start mb-4 md:mb-0 md:mr-6'>
                            <img src={publicUrl + '/assets/img/blog/division/D6DNA.jpg'} alt="D6 DNA" className='w-full max-w-xs sm:max-w-md md:max-w-md rounded-lg shadow-lg mb-4' style={{objectFit: 'contain'}} />
                            <img src={publicUrl + '/assets/img/blog/division/D6BodyPart.jpg'} alt="D6 Body Parts" className='w-full max-w-xs sm:max-w-md md:max-w-md rounded-lg shadow-lg' style={{objectFit: 'contain'}} />
                        </div>
                        <div className='md:w-1/2 w-full'>
                ...
                <div style={{ width: "84vw", maxWidth: "1100px", margin: "32px auto 0 auto" }}>
                    ...
                    <div style={{ height: '40vw', minHeight: '220px', maxHeight: '70vh', width: "100%" }}>
                        <iframe
                            width="100%"
                            height="100%"
                            ...
                            allowFullScreen
                            style={{ borderRadius: '12px', display: 'block', minHeight: '220px', maxHeight: '70vh' }}
                        ></iframe>
                    </div>
                </div>
